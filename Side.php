<!-- 
  Side Dishes page 
  * shows side dishes recipes from TheMealDB API 
-->
...
<head>
    ...
    <title>SCRAN | Side Dishes</title>
    <link rel="icon" type="image/x-icon" href="/images/favi.png">

</head>

<body class="page-side">
...
<section class="scran-hero-main d-flex align-items-center justify-content-center text-center">
  ...
  <div class="scran-hero-main-content container">
    <h1 class="scran-hero-main-title">Side Dishes</h1>
  </div>
</section>

<!-- RECIPES -->
<section class="container my-5">
  <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4" id="side-container">
  </div>
</section>
...
async function loadSideRecipes(){
  ...
  document.addEventListener("DOMContentLoaded", loadSideRecipes);
</script>
</body>
</html>