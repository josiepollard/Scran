<!-- 
  Vegetarian page 
  * shows vegetarian recipes from TheMealDB API 
-->
...
<head>
    ...
    <title>SCRAN | Vegetarian Recipes</title>
    <link rel="icon" type="image/x-icon" href="/images/favi.png">

</head>

<body class="page-vegetarian">
...
<section class="scran-hero-main d-flex align-items-center justify-content-center text-center">
  ...
  <div class="scran-hero-main-content container">
    <h1 class="scran-hero-main-title">Vegetarian</h1>
  </div>
</section>

<!-- RECIPES -->
<section class="container my-5">
  <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4" id="vegetarian-container">
  </div>
</section>
...
//=================================
async function loadVegetarianRecipes(){

  const container = document.getElementById("vegetarian-container");
...
//=================================
  ...
  document.addEventListener("DOMContentLoaded", loadVegetarianRecipes);
</script>
