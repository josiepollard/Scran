<!-- 
  Breakfast page 
  * shows breakfast recipes from TheMealDB API 
-->
...
<head>
  ...
  <title>SCRAN | Breakfast recipes</title>
...
<body class="page-breakfast">
  ...
  // Fetch breakfast recipes from API and display
    async function loadBreakfastRecipes(){
      ...
      try{
      const response = await fetch("https://www.themealdb.com/api/json/v1/1/filter.php?c=Breakfast"); // TheMealDB API
