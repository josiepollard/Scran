<!-- 
  Desserts page 
  * shows desserts recipes from TheMealDB API 
-->
...
<head>
    ...
    <title>SCRAN | Dessert recipes</title>
    <link rel="icon" type="image/x-icon" href="/images/favi.png">
</head>

<body class="page-desserts">
...
<section class="container my-5">
  <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4" id="dessert-container">
  </div>
</section>
...
//=================================
// Fetch dessert recipes from API and display
//=================================
...
//=================================
  ...
  document.addEventListener("DOMContentLoaded", loadDessertRecipes);
</script>
</body>
</html>