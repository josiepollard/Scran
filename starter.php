<!-- 
  starters page
  * shows recipes from TheMealDB API 
-->
...
<section class="scran-hero-main d-flex align-items-center justify-content-center text-center">
  ...
  <div class="scran-hero-main-content container">
    <h1 class="scran-hero-main-title">Starters</h1>
  </div>
</section>
...
<section class="container my-5">
  <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4" id="starter-container">
  </div>
</section>
...
async function loadStarterRecipes(){
  ...
  document.addEventListener("DOMContentLoaded", loadStarterRecipes);
</script>
</body>
</html>